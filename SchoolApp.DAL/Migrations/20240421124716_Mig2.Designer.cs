            ...
            modelBuilder.Entity("SchoolApp.Models.DataModels.Attendance", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Date = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1507),
                            IsPresent = true,
                            Type = 0
                        },
                        new
                        {
                            AttendanceId = 2,
                            AttendanceIdentificationNumber = 111,
                            Date = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1517),
                            IsPresent = true,
                            Type = 0
                        },
                        new
                        {
                            AttendanceId = 3,
                            AttendanceIdentificationNumber = 111,
                            Date = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1518),
                            IsPresent = true,
                            Type = 0
                        },
                        new
                        {
                            AttendanceId = 4,
                            AttendanceIdentificationNumber = 111,
                            Date = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1519),
                            IsPresent = true,
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("SchoolApp.Models.DataModels.Mark", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Feedback = "Good job!",
                            Grade = 1,
                            MarkEntryDate = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1652),
                            ObtainedScore = 65,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 1,
                        ...
                        new
                        {
                            ...
                            Grade = 0,
                            MarkEntryDate = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1656),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 2,
                        ...
                        new
                        {
                            ...
                            Feedback = "Excellent work!",
                            Grade = 0,
                            MarkEntryDate = new DateTime(2024, 4, 21, 18, 47, 14, 493, DateTimeKind.Local).AddTicks(1658),
                            ObtainedScore = 75,
                            PassMarks = 40,
                            PassStatus = 0,
                            StaffId = 3,
